...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'Civins_elliotEcommerce_vin_884d78be30c056081715_20220314151345_archive.zip';
	const ARCHIVE_SIZE		 = '87858670';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '884d78b-14151345';
    const SECONDARY_PACKAGE_HASH = 'b8b4ec3-14151345';
	const VERSION			 = '1.4.4';
