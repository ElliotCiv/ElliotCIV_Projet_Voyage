...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'Civins_ElliotProjet1_Voyage_67da62d4bd53aca82036_20220311105541_archive.zip';
	const ARCHIVE_SIZE		 = '55728057';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '67da62d-11105541';
    const SECONDARY_PACKAGE_HASH = 'bd79236-11105541';
	const VERSION			 = '1.4.4';
